...
#define M0 OMAP_MUX_MODE0
#define M1 OMAP_MUX_MODE1
#define M2 OMAP_MUX_MODE2
#define M3 OMAP_MUX_MODE3
#define M4 OMAP_MUX_MODE4
#define M5 OMAP_MUX_MODE5
#define M6 OMAP_MUX_MODE6
#define M7 OMAP_MUX_MODE7
#define IDIS 	(0 << 8)
#define IEN 	OMAP_INPUT_EN
#define PD 		OMAP_PULL_ENA
#define PU 		(OMAP_PULL_ENA | OMAP_PULL_UP)
#define PI 		(0 << 3)


#define OMAP3_CONTROL_PADCONF_MUX_PBASE				0x48002030LU
#define NDU_CONTROL_PADCONF_MUX_PBASE				0x48002000LU	// DCY
#define BASE_DIFF					(OMAP3_CONTROL_PADCONF_MUX_PBASE - NDU_CONTROL_PADCONF_MUX_PBASE) 		
...
#define CONTROL_PADCONF_SDRC_CKE0                 0x0266
...
#define MUX_VAL(mode0, mux_value)					\
{									\
	.reg_offset	= (mode0),	\
	.value		= (mux_value),					\
},
