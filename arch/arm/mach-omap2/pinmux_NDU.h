...
MUX_VAL(CONTROL_PADCONF_MMC1_CLK, (IEN | PI | M4 )) /* gpio_120 */\
...
MUX_VAL(CONTROL_PADCONF_MMC1_DAT4, (IDIS | PI | M4 )) /* gpio_126 */\
MUX_VAL(CONTROL_PADCONF_MMC1_DAT5, (IEN | PI | M4 )) /* gpio_127 */\
...
MUX_VAL(CONTROL_PADCONF_UART1_CTS, (IDIS | PI | M4 )) /* gpio_150 */\
MUX_VAL(CONTROL_PADCONF_UART1_RTS, (IDIS | PI | M4 )) /* gpio_149 */\
...
MUX_VAL(CONTROL_PADCONF_UART3_CTS_RCTX, (IDIS | PI | M4 )) /* gpio_163 */\
