...
MUX_VAL(CONTROL_PADCONF_DSS_DATA0, (IEN | PD | M4 )) /* gpio_70 */\
...
MUX_VAL(CONTROL_PADCONF_HECC1_TXD, (IEN | PD | M4 )) /* gpio_130 */\
...
MUX_VAL(CONTROL_PADCONF_MCBSP2_DR, (IEN | PD | M4 )) /* gpio_118 */\
MUX_VAL(CONTROL_PADCONF_MCBSP2_DX, (IEN | PD | M4 )) /* gpio_119 */\
...
MUX_VAL(CONTROL_PADCONF_MMC2_CLK, (IEN | PU | M2 )) /* uart4_cts */\
MUX_VAL(CONTROL_PADCONF_MMC2_CMD, (IDIS | PU | M2 )) /* uart4_rts */\
...
MUX_VAL(CONTROL_PADCONF_MMC2_DAT4, (IEN | PD | M0 )) /* mmc2_dat4 */\
MUX_VAL(CONTROL_PADCONF_MMC2_DAT5, (IEN | PD | M0 )) /* mmc2_dat5 */\
MUX_VAL(CONTROL_PADCONF_MMC2_DAT6, (IEN | PD | M0 )) /* mmc2_dat6 */\
MUX_VAL(CONTROL_PADCONF_MMC2_DAT7, (IEN | PD | M0 )) /* mmc2_dat7 */\
